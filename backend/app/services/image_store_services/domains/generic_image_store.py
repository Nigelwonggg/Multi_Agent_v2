...
class GenericImageStore(BaseImageStoreService):
    """Image store service for generic domains"""
    ...
    def _get_domain_config(self) -> Dict[str, str]:
        ...
        return {
            "directory": f"./vector_databases/custom_image_domains/{self.domain}_image_db",
            "collection_name": f"{self.domain}_image_db"
        }
