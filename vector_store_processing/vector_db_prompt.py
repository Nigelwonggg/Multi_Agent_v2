# Available domains for prompt generation
AVAILABLE_DOMAINS = ["data_science", "medical"]

def get_available_domains():
    """
    Return the list of available domains for prompt generation.
    """
...
<Example_1>
<Summary>
Bar Chart Comparison of Classification Algorithms
Vertical bar chart comparing accuracy scores of Random Forest (82%), SVM (78%), and Logistic Regression (75%) classifiers. X-axis shows algorithm names, y-axis ranges 70-85% accuracy. Demonstrates model evaluation techniques and performance benchmarking - relevant to machine learning, model selection, and experimental design.
</Summary>
<Thought>
Identifying bar chart elements showing classifier performance comparisons. Connecting accuracy percentages to model evaluation concepts. Relevant to machine learning benchmarks and experimental design.
</Thought>
</Example_1>
...
Sequential diagram showing data transformation steps: raw input → missing value imputation → outlier detection → feature scaling → encoded features. Arrows indicate flow between processing stages. Relates to data preprocessing, pipeline construction, and dimensionality reduction concepts.
</Summary>
<Thought>
Analyzing sequential workflow diagram with feature engineering stages. Highlighting preprocessing pipeline components and transformation flow. Connects to data preparation and dimensionality reduction concepts.
</Thought>
</Example_2>
"""
...
<Example_1>
<Summary>
ECG Rhythm Strip Showing Atrial Fibrillation Pattern
12-lead electrocardiogram displaying irregular R-R intervals with absent P-waves and fibrillatory baseline activity characteristic of atrial fibrillation. Heart rate approximately 110 bpm with normal QRS morphology. Demonstrates cardiac arrhythmia diagnosis and electrophysiological monitoring - relevant to cardiology, emergency medicine, and clinical electrophysiology.
</Summary>

<Thought>
Identifying ECG trace elements showing atrial fibrillation characteristics. Connecting irregular rhythm patterns to arrhythmia diagnosis concepts. Relevant to cardiovascular medicine and emergency care protocols.
</Thought>
</Example_1>

<Example_2>
<Summary>
Chest X-ray Posteroanterior View Normal Lung Fields
Frontal chest radiograph showing clear bilateral lung fields with normal cardiothoracic ratio, visible costophrenic angles, and no signs of consolidation or pneumothorax. Cardiac silhouette within normal limits with clear hemidiaphragms. Relates to pulmonary medicine, diagnostic radiology, and thoracic imaging interpretation.
</Summary>

<Thought>
Analyzing chest X-ray components with normal anatomical structures. Highlighting radiological findings and imaging interpretation. Connects to respiratory medicine and diagnostic imaging concepts.
</Thought>
</Example_2>
"""
